              ...
              <div class="params-block">
                <ul>
                  ...
                  <li class='param-block'>
					...
					<img src="img/imgCoffee/fon.jpg" class="img-fluid my-2 kenia-img">
					<p>Кения Спайкс</p>
					<form method='post' class='form-option kenia-form' action='order.php'>
						<div class = 'options-block'>
							<select name='options[coffee-mil]' class = 'kenia-select' id=''>
						...
						<div class='price-block'>
							...
							<button class='btn btn-border ml-5 kenia-button' type='submit' name='action-buy'>
              ...
              <div class="params-block">
                <ul>
                  ...
                  <li class='param-block'>
					...
					<img src="img/imgCoffee/fon.jpg" class="img-fluid my-2 guatemala-img">
					<p>Гватемала</p>
					<form method='post' class='form-option'>
						<div class = 'options-block'>
							<select name='options[coffee-mil]' class = 'guatemala-select' id=''>
								<option value='grains'>Не молоть (в зернах)</option>
								<option value='aeropress'>Для аэропресса</option>
								<option value='drip-coffee-maker'>Для капельной кофеварки</option>
								<option value='turka'>Для турки</option>
						...
						<div class='price-block'>
							...
							<button class='btn btn-border ml-5 guatemala-button' type='submit' name='action-buy' value='cart/add'>
								<i class="fas fa-shopping-basket"></i>
								<span>Купить</span>
							</button>
						</div>
              ...
              <div class="params-block">
                <ul>
                  ...
                  <li class='param-block'>
					...
					<img src="img/imgCoffee/fon.jpg" class="img-fluid my-2 efiopia-img">
					<p>Эфиопия</p>
					<form method='post' class='form-option'>
						<div class = 'options-block'>
							<select name='options[coffee-mil]' class = 'efiopia-select' id=''>
								<option value='grains'>Не молоть (в зернах)</option>
								<option value='aeropress'>Для аэропресса</option>
								<option value='drip-coffee-maker'>Для капельной кофеварки</option>
								<option value='turka'>Для турки</option>
						...
						<div class='price-block'>
							...
							<button class='btn btn-border ml-5 efiopia-button' type='submit' name='action-buy' value='cart/add'>
								<i class="fas fa-shopping-basket"></i>
								<span>Купить</span>
							</button>
						</div>
  			...
  			<div class="row justify-content-center">
  				...
  				<div class="col-sm-12 col-md-8    right">
  				   <div class="form-group">
  				   	 <input type="text" class="form-control form-control-lg" placeholder="Ваше Имя" name="form_name">
  				   </div>
  				   <div class="form-group">
  				   	 <input type="email" class="form-control form-control-lg" placeholder="ВашаПочта@email.com" name="form_email">
  				   </div>
  				   <div class="form-group">
  				   	 <textarea class="form-control form-control-lg" name="form_text" maxlength="100" >
  				   	 </textarea>
  				   </div>
  				   <input type="submit" class="btn btn-secondary btn-block btn-text" value="Отправить">
  				</div>
  			</div>
  		</form>
  	</div>
